...
export default function Page() {
  return (
    <div className="relative left-1/2 grid w-[min(100vw,1760px)] -translate-x-1/2 gap-8 px-4 sm:px-6 lg:px-8 xl:grid-cols-[12rem_minmax(0,1fr)] 2xl:px-12">
      <HomepageSideNav />
      <main className="relative flex min-h-dvh min-w-0 w-full flex-col gap-24 py-16">
        ...
        {/* 2. Tech Stack */}
        <SectionCard id="tech-stack" delay={BLUR_FADE_DELAY * 7} className="scroll-mt-24 p-10 space-y-8">
          <TechStackSection blurFadeDelay={BLUR_FADE_DELAY} />
        </SectionCard>

        {/* 3. Work & Education */}
        <SectionCard id="experience" delay={BLUR_FADE_DELAY * 13} className="scroll-mt-24 p-10 space-y-12">
